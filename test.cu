...
struct generic_product_impl<MatrixReplacement, Rhs, SparseShape, DenseShape,
  ...
  evalTo(Dst &dst, const MatrixReplacement &lhs, const Rhs &rhs) {
    dst.setZero();
  ...
  template <typename Dst>
  static EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE void
  addTo(Dst &dst, const MatrixReplacement &lhs, const Rhs &rhs) {
    scaleAndAddTo(dst, lhs, rhs, Scalar(1));
  }

  template <typename Dst>
  static EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE void
  subTo(Dst &dst, const MatrixReplacement &lhs, const Rhs &rhs) {
    scaleAndAddTo(dst, lhs, rhs, Scalar(-1));
  }

  template <typename Dest>
  static EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE void
  scaleAndAddTo(Dest &dst, const MatrixReplacement &lhs, const Rhs &rhs,
                const Scalar &alpha) {
